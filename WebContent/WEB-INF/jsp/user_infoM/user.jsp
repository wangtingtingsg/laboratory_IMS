...
function message(){
	...
	window.open("${pageContext.request.contextPath }/message", " " ,"height=500,width=1000,top=150,left=300,scrollbars=no,location=no" ) ;
}
function out(){
	//alert("我点击按钮了:"+select+select1);
...
<div class="top-logo"></div>
	...
	<div class="other-head">欢迎您，${user_id}</div>
		...
		<iframe style="border: solid; position: absolute; top:21%;left:10%; width:90%;height:85%;border-width: 1px"
				src="${pageContext.request.contextPath }/userList" id="i11">
	    </iframe>
</body>
</html>
