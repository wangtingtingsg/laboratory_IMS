...
<div class="top-logo"></div>
	<div class="top-background">
		...
		<a href="${pageContext.request.contextPath }/smessage" class="top-photo"></a> 
	...
	<div class="left-background">
		<ul>
			<li>
				<a href="${pageContext.request.contextPath }/slabListP" class="menu words-white choice left-0"
					style="top: 0%" id="set1">实验预约</a> 
			</li>
		</ul>
	</div>
	<script type="text/javascript">
	...
	<div class="other-head">欢迎您，${user_id}</div>
		...
		<iframe style="border: solid; position: absolute; top:21%;left:10%; width:90%;height:85%;border-width: 1px"
				src="${pageContext.request.contextPath }/selabList" id="i11">
	    </iframe>
</body>
</html>
